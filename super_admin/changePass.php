...
try {
    ...
    // Verify old password
    $stmt = $conn->prepare("SELECT password FROM supadmin WHERE spAd_id = ? AND password = ?");
    ...
    if (isset($_FILES['profilePic']) && $_FILES['profilePic']['error'] === UPLOAD_ERR_OK) {
        ...
        $query = "SELECT image FROM supadmin WHERE spAd_id = ?";
    ...
    // Update user profile
    $query = "UPDATE supadmin SET password = ?";
    $params = [$newPassword];
    $types = "s";
